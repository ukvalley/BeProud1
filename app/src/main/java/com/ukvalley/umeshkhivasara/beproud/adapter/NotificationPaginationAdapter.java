...
public class NotificationPaginationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public NotificationPaginationAdapter(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case ITEM:
                ...
                break;
            case LOADING:
                View v2 = inflater.inflate(R.layout.notification_layout, parent, false);
                viewHolder = new NotificationPaginationAdapter.LoadingVH(v2);
                break;
        }
    ...
    private RecyclerView.ViewHolder getViewHolder(ViewGroup parent, LayoutInflater inflater) {
        ...
        View v1 = inflater.inflate(R.layout.notification_layout, parent, false);


        viewHolder = new NotificationPaginationAdapter.MovieVH(v1);
        return viewHolder;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (getItemViewType(position)) {
            case ITEM:
                final NotificationPaginationAdapter.MovieVH movieVH = (NotificationPaginationAdapter.MovieVH) holder;
                ...
                if (result.getType().equals("event")) {
                    holder.itemView.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            String id = String.valueOf(result.getEventId());
            ...
            if (!result.getType().equals("event")  && !result.getType().equals("news")  && !result.getUrl().equals("")) {
                    holder.itemView.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                ...
                movieVH.notification_title.setText(result.getTitle());

                movieVH.notification_type.setText(result.getType());
                ...
                *//**
                ...
                Glide
                        ...
                        .centerCrop()
                        .crossFade()
                        .into(movieVH.notification_image);
    ...
    */
    ...
    protected class MovieVH extends RecyclerView.ViewHolder {
        ...
        public MovieVH(View itemView) {
          ...
          notification_image=itemView.findViewById(R.id.image_notification);
